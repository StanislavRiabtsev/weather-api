            ...
            <div className="icon-position" title="Fog">
                <svg id="fog" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
                    ...
                    <g>
                        <path
                            id="f-cloud"
                            d="M3.25,49.5A17.51,17.51,0,0,1,20.75,32a16.84,16.84,0,0,1,3.12.29,27,27,0,0,1,49.69-5A19.71,19.71,0,0,1,76.75,27a20,20,0,0,1,20,20,20.24,20.24,0,0,1-.12,2.22"
                            style={{ fill: '#fff', fillOpacity: 0, fillRule: 'evenodd' }}
                        />
